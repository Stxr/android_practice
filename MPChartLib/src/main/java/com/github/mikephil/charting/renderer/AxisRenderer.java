...
public abstract class AxisRenderer extends Renderer {
     ...
     * 填充区域的画笔
     */
    protected Paint mRangeFilledPaint;
    ...
    public AxisRenderer(ViewPortHandler viewPortHandler, Transformer trans, AxisBase axis) {
        ...
        if(mViewPortHandler != null) {
            ...
            mLimitRangePaint.setStyle(Style.STROKE);

            mRangeFilledPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
            mLimitRangePaint.setStyle(Style.FILL);
        }
    }
